...
In Linear Programming a goal function and constraints are used to compute the optimal solution, as described in \citep{2}.

\subsection{Goal function and Constraints}
bla bla
