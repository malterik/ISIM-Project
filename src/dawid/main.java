...
public class main {
    ...
    /* Verify body */        
        LogTool.print("     MaxDose 3,0,1 : " + body[3][0][1].getMaxDosis() + "","notification");
    ...
    /* Attack the problem using SA */
        ...
        LogTool.print("seeds, curstate,newstate" + looper.getCur_state().toString() + " " + looper.getNew_state() + " ","notification");
